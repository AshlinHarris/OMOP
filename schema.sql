...
CREATE TABLE Condition_Occurrence (
	condition_occurrence_id double precision  PRIMARY KEY,
 	...
 	condition_start_datetime timestamp (16),
 	condition_end_date date,
 	condition_end_datetime timestamp (16),
...
CREATE TABLE Device_Exposure (
	device_exposure_id double precision  PRIMARY KEY,
 	...
 	device_exposure_start_datetime timestamp (16),
 	device_exposure_end_date date,
 	device_exposure_end_datetime timestamp (16),
...
CREATE TABLE Drug_Exposure (
	drug_exposure_id double precision  PRIMARY KEY,
 	...
 	drug_exposure_start_datetime timestamp (16),
 	drug_exposure_end_date date,
 	drug_exposure_end_datetime timestamp (16),
...
CREATE TABLE Procedure_Occurrence (
	procedure_occurrence_id double precision PRIMARY KEY,
 	...
 	procedure_date date,
 	procedure_datetime timestamp (16),
...
CREATE TABLE Visit_Occurrence (
	visit_occurrence_id double precision  PRIMARY KEY,
 	...
 	visit_start_datetime timestamp (16),
 	visit_end_date date,
 	visit_end_datetime timestamp (16),
